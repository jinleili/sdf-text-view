...
impl ParticleNode {
    pub fn new(
        ...
        particle_nx: u32, particle_ny: u32,
    ) -> Self {
        use std::mem;
        let mut encoder =
        ...
        let particle_position_tv = crate::texture::empty_f32_view(device, particle_nx, particle_ny);
        // Create bind group
        ...
        let shader = crate::shader::Shader::new("fluid/particle_rendering", device);
        ...
        let depth_texture_view = crate::depth_stencil::create_depth_texture_view(sc_desc, device);
        {
            ...
            let shader = crate::shader::Shader::new_by_compute("fluid/particle_init", device);
