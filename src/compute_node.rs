...
impl SDFComputeNode {
    pub fn new(
        ...
        let visibilitys: Vec<wgpu::ShaderStage> = [wgpu::ShaderStage::COMPUTE; 7].to_vec();
    ...
    pub fn compute(&mut self, _device: &mut wgpu::Device, encoder: &mut wgpu::CommandEncoder) {
        ...
        cpass.set_bind_group(0, &self.setting_node.bind_group, &[0]);
